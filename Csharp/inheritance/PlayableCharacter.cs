...
namespace Inheritance
{
    internal abstract class PlayableCharacter : IHp, IAttacker
    {
        ...
        // Generic 타입
        // 타입을 미리 정의해놓는게 아니라, 특정 타입에 따라 다른 정의를 할 수 있드로고
        // 그 형태만 정의해놓는 타입
        // 특징은 컴파일타입에, 특정 타입을 명시해놓고 이 Generic타입을 쓰는 코드가 있으면
        // 컴파일러가 그 정의를 만들어서 그 빌드를 추가함.

        // PlayableCharater 타입으로 사용하는 코드가 있다면, 아래 정의를 컴파일타임에 추가함.
        // Public void DepleteHp(PlayableCharater subject, float amount)
        //{
        //      hpValue -= amount;
        //}
